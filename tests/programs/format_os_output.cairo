...
func main{output_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    ...
    assert [initial_state_updates_ptr + 1] = 1005161437792794307757078281996005783125378987969285529172328835577592343232;
    assert [initial_state_updates_ptr + 2] = 340282366920938463463374607431768211462;
    assert [initial_state_updates_ptr + 3] = 692694963414257194264020892248745848197431340753065024006875718260869872089;
    assert [initial_state_updates_ptr + 4] = 123;
    assert [initial_state_updates_ptr + 5] = 456;
    assert [initial_state_updates_ptr + 6] = 300;
    assert [initial_state_updates_ptr + 7] = 2215430303710902791540996484823030809971452078551498009603035870583464052788;
    assert [initial_state_updates_ptr + 8] = 311;
    assert [initial_state_updates_ptr + 9] = 1536727068981429685321;
    assert [initial_state_updates_ptr + 10] = 322;
    assert [initial_state_updates_ptr + 11] = 19;
    assert [initial_state_updates_ptr + 12] = 815679926571212018227195848707562322348558067406060931041239273854107494620;
    assert [initial_state_updates_ptr + 13] = 2;
    assert [initial_state_updates_ptr + 14] = 1316419243995606702889870694869183679645676506242823596326912212936248352465;
    assert [initial_state_updates_ptr + 15] = 3262122051170176624039908867798875903980511552421730070376672653403179864416;
    assert [initial_state_updates_ptr + 16] = 2006810680437147719782949677362224138923732654511812452693656965873469983890;
    assert [initial_state_updates_ptr + 17] = 340282366920938463463374607431768211461;
    assert [initial_state_updates_ptr + 18] = 2084524728099985327606460172540572310995923661656859675449923268913980850263;
    assert [initial_state_updates_ptr + 19] = 85;
    assert [initial_state_updates_ptr + 20] = 47;
    assert [initial_state_updates_ptr + 21] = 321;
    assert [initial_state_updates_ptr + 22] = 543;
    assert [initial_state_updates_ptr + 23] = 444;
    assert [initial_state_updates_ptr + 24] = 666;
    assert [initial_state_updates_ptr + 25] = 1715425246256821823855536409958992540846451989567087551676457027799652256186;
    assert [initial_state_updates_ptr + 26] = 100;
    assert [initial_state_updates_ptr + 27] = 1715425246256821823855536409958992540846451989567087551676457027799652256187;
    assert [initial_state_updates_ptr + 28] = 200;
    assert [initial_state_updates_ptr + 29] = 2221633069513894212967173919871301977519426338681819384231748898933664013766;
    assert [initial_state_updates_ptr + 30] = 340282366920938463463374607431768211460;
    assert [initial_state_updates_ptr + 31] = 3262122051170176624039908867798875903980511552421730070376672653403179864416;
    assert [initial_state_updates_ptr + 32] = 15;
    assert [initial_state_updates_ptr + 33] = 1;
    assert [initial_state_updates_ptr + 34] = 111;
    assert [initial_state_updates_ptr + 35] = 987;
    assert [initial_state_updates_ptr + 36] = 555;
    assert [initial_state_updates_ptr + 37] = 888;
    assert [initial_state_updates_ptr + 38] = 666;
    assert [initial_state_updates_ptr + 39] = 999;
    assert [initial_state_updates_ptr + 40] = 2618767603815038378512366346550627731109766804643583016834052353912473402832;
    assert [initial_state_updates_ptr + 41] = 442721857769029238784;
    assert [initial_state_updates_ptr + 42] = 3302098605493938887217934688678356071939708546668669666319008757914002811976;
    assert [initial_state_updates_ptr + 43] = 340282366920938463463374607431768211456;
    assert [initial_state_updates_ptr + 44] = 3262122051170176624039908867798875903980511552421730070376672653403179864416;
    assert [initial_state_updates_ptr + 45] = 0;
    ...
    os_output_serialize(
        ...
        state_updates_ptr_end=initial_state_updates_ptr + 46,
