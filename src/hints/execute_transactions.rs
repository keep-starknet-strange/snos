...
pub async fn start_tx_validate_declare_execution_context_async<S: Storage + Clone + 'static>(
...
pub fn start_tx_validate_declare_execution_context<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
