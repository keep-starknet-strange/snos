...
impl GetSecpSyscallHandler<ark_secp256k1::Config> for ExecutionHelper {
    fn get_secp_handler(&mut self) -> &mut SecpHintProcessor<ark_secp256k1::Config> {
        &mut self.secp256k1_syscall_processor
    }
}

impl GetSecpSyscallHandler<ark_secp256r1::Config> for ExecutionHelper {
...
where
    ExecutionHelper: GetSecpSyscallHandler<C>,
