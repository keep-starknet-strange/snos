...
use starknet_api::{core::ClassHash, hash::{poseidon_hash_array, StarkFelt}, state::{ContractClass, EntryPointType}};
...
/// Calculate the hash of a contract v1. Inspired by the Papyrus implementation.
