    ...
    let block_info = BlockInfo {
        ...
        gas_prices: GasPrices {
            ...
            eth_gas_prices: GasPriceVector {
                l1_gas_price: NonzeroGasPrice::new(GasPrice(felt_to_u128(&block.l1_gas_price.price_in_wei).unwrap()))
                    .unwrap(),
            ...
            strk_gas_prices: GasPriceVector {
                l1_gas_price: NonzeroGasPrice::new(GasPrice(felt_to_u128(&block.l1_gas_price.price_in_fri).unwrap()))
                    .unwrap(),
                l1_data_gas_price: NonzeroGasPrice::new(GasPrice(
